...
impl Default for SearchTuneParams {
    fn default() -> Self {
        Self {
            ...
            // Group A
            correction_value_pcv_weight: 12153,
            correction_value_micv_weight: 8620,
            correction_value_nonpawn_weight: 12355,
            correction_value_cnt_weight: 7982,
            correction_history_non_pawn_weight: 187,
            correction_history_minor_piece_mult: 153,
            correction_history_cont_ss2_weight: 126,
            correction_history_cont_ss4_weight: 63,
            // Group B
